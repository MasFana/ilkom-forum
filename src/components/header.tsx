...
export default function Header() {
    ...
    return (
        <div className="sticky top-0 z-30 backdrop-blur bg-white/70 dark:bg-neutral-950/70 border-b border-black/10 dark:border-white/10">
            <div className="mx-auto max-w-6xl p-2   flex items-center gap-3">
                ...
                <div className="ml-auto flex items-center gap-2">
                    {mounted && isAuth ? (
                        ...
                        <Link href="/login" className="inline-flex items-center gap-1"><LogIn className="h-4 w-4" />Masuk</Link>
                    )}
                </div>
            </div>
        </div>
